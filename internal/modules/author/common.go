...
func (uca *useCaseAuthor) bindJSON(author *Author) error {
	if err := uca.c.BindJSON(author); err != nil {
		var errs []string
...
func (uca *useCaseAuthor) isErrRecordNotFound(err error) {
...
func (uca *useCaseAuthor) returnError(code int, err error) {
